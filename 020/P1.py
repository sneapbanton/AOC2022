...
for i in range(len(ordering)):
    print(ordering[i].val, original_ordering[i].val)

pos_zero = [x.val for x in ordering].index(0)
print("zero pos",pos_zero)
print(ordering[(pos_zero+1000)%limit].val)
print(ordering[(pos_zero+2000)%limit].val)
print(ordering[(pos_zero+3000)%limit].val)
print(sum([ordering[(pos_zero+1000)%limit].val, ordering[(pos_zero+2000)%limit].val, ordering[(pos_zero+3000)%limit].val]))